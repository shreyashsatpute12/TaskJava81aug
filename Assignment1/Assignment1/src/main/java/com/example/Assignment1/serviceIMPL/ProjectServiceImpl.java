package com.example.Assignment1.serviceIMPL;
...
import com.example.Assignment1.dao.ProjectRepository;
import com.example.Assignment1.dto.ProjectDTO;
import com.example.Assignment1.entity.ProjectDetails;
import com.example.Assignment1.services.ProjectService;
...
public class ProjectServiceImpl implements ProjectService {
	...
	public void updatePorjectDetails(int ProjectId) throws ProjDetailsNotFound {
		...
		ProjectDetails projectDetails = optional
				.orElseThrow(() -> new ProjDetailsNotFound("Project Details not found"));
